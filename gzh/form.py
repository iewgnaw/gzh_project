...
class AccountForm(forms.Form):
    ...
    delivery_switch = forms.BooleanField(
    ...
    def clean_delivery_switch(self):
        if (not self.clean_kindle_email()) and self.cleaned_data.get(
                'delivery_switch'):
